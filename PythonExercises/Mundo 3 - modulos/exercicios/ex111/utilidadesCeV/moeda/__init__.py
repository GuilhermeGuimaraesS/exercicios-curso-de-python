...
def resumo(n=0, perc_a = 10,  perc_r = 5):
    """
    -> Função que analisa um valor fornecido e retorna ele próprio, seu dobro, sua metade, aumento(opcional; padrão 10%) e redução (opcional; padrão 5%). A função guarda todos os dados em um dicionário
